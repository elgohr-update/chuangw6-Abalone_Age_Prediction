...
python src/data_wrangling/pre_process_abalone_data.py --input=data/raw/abalone.csv --out_dir=data/preprocess

# run EDA process
python src/eda/abalone_eda.py --train=data/preprocess/training.csv --out_dir=results/eda
